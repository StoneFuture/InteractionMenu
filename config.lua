...
Config.MenuTitleCustom = 'TSDOJRP Interaction Menu'
...
Config.LEOVehiclesCategories = {
    ...
    ['Deputy'] = {
		{name = 'Crown Vic', spawncode = 'tr11vic'},
	},
	
	['Deputy First Class'] = {
		{name = 'Caprice', spawncode = 'tr12caprice'},
	},

    ['Master Deputy'] = {
        {name = '2014 Charger', spawncode = 'tr14charger'},
    },

    ['Corporal'] = {
        {name = '2019 Ford Fusion', spawncode = 'fusion LEO'},

        {name = '2014 Dodge Ram', spawncode = 'tr14ram'},
    },

    ['Sergeant'] = {
        {name = '2016 Ford Explorer', spawncode = 'tr16explorer'},
    },

    ['Lieutenant'] = {
        {name = '2014 Chevy Tahoe', spawncode = 'tr14tahoe'},
    },


    ['Captain'] = {
        {name = '2018 Ford Taurus', spawncode = 'tr18taurus'},
    },


    ['Major'] = {
        {name = '2018 Dodge Charger', spawncode = 'tr18charger'},
    },

        
    ['Chief Deputy Sheriff'] = {
        {name = '2019 Dodge Challenger', spawncode = 'pdhellcat'},
    },


    ['Assistant Sheriff'] = {
        {name = '2019 Chevy Tahoe', spawncode = 'tr19tahoe'},
